...
import LoadingScreen from './../../../generalComponents/general/LoadingScreen';
...
const PreviewForm = (props) => {
    ...
    const formSubmitHandler = (event) => {
        ...
        ReactDOM.render(<LoadingScreen message={`Prosíme o trpělivost Vaše soubory se připravují.`}/>, document.getElementById('root'));
        //
